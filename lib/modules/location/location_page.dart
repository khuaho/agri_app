...
import '../../global/utils/dialog.dart' as util;
import 'config/env.dart';
import 'widgets/event_list.dart';
import 'widgets/map_view.dart';
import 'widgets/shared_events.dart';
...
class LocationPageState extends State<LocationPage>
    with TickerProviderStateMixin<LocationPage>, WidgetsBindingObserver {
  ...
  void _onClickTestMode() {
    ...
    testModeTimer = Timer(const Duration(seconds: 2), () {
      _testModeClicks = 0;
    });
  }
